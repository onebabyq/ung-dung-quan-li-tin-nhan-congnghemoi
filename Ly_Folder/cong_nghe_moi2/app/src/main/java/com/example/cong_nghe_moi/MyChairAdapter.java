...
public class MyChairAdapter extends RecyclerView.Adapter<MyChairAdapter.MyViewHolder> {
    List<com.example.cong_nghe_moi.Friend> friendList;
    Context context;

    public MyChairAdapter(List<com.example.cong_nghe_moi.Friend> friendList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder h, int position) {
        com.example.cong_nghe_moi.Friend friend = friendList.get(position);
