...
public class LoginActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void register() {
            Intent intent = new Intent(context, com.example.android_finally.RegisterActivity.class);
    ...
    public void login_fix(String URL) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                Toast.makeText(com.example.android_finally.LoginActivity.this, "sai mk", Toast.LENGTH_SHORT).show();
