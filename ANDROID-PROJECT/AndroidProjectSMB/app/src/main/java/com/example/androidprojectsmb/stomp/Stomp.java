...
import com.example.androidprojectsmb.stomp.provider.OkHttpConnectionProvider;
import com.example.androidprojectsmb.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(com.example.androidprojectsmb.stomp.provider.ConnectionProvider connectionProvider) {
