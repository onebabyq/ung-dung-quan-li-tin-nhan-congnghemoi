...
public class StompMessage {
    ...
    //private final ChatMessage mPayload;

    public StompMessage(String stompCommand, List<StompHeader> stompHeaders, String payload) {
    //public StompMessage(String stompCommand, List<StompHeader> stompHeaders, ChatMessage payload) {
    ...
    public static StompMessage from(@Nullable String data) {
       ...
       // return new StompMessage(command, headers, data);
    ...
    public String toString() {
        return "StompMessage{" +
                "mStompCommand='" + mStompCommand + '\'' +
                ", mStompHeaders=" + mStompHeaders +
                ", mPayload='" + mPayload + '\'' +
                '}';
    }
}
